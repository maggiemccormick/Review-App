...
class PopularReviewsListView extends StatefulWidget {
  const PopularReviewsListView({Key key, this.callBack}) : super(key: key);

  final Function callBack;
  @override
  _PopularReviewsListViewState createState() => _PopularReviewsListViewState();
}

class _PopularReviewsListViewState extends State<PopularReviewsListView>
              ...
              children: List<Widget>.generate(
                ...
                (int index) {
                  ...
                  return CategoryView(
                    ...
                    category: Review.popularCourseList[index],
                    animation: animation,
                    animationController: animationController,
                  );
                },
