...
class ReviewInfoScreen extends StatefulWidget {
  @override
  _ReviewInfoScreenState createState() => _ReviewInfoScreenState();
}

class _ReviewInfoScreenState extends State<ReviewInfoScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    animation = Tween<double>(begin: 0.0, end: 1.0).animate(CurvedAnimation(
        parent: animationController, curve: Interval(0, 1.0, curve: Curves.fastOutSlowIn)));
    setData();
    super.initState();
  }
